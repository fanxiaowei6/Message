...
public class UserServiceImpl extends BaseServiceImpl<User>  implements UserService {
		...
		try {
			...
			if(sheet.getPhysicalNumberOfRows()>2){
				...
				//读取单元格
					...
					user.setGender(cell3.getStringCellValue().equals("女"));
					//手机号
					String mobile="";
					...
					try {
						email=cell5.getStringCellValue();
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						double demail=cell5.getNumericCellValue();
						email=BigDecimal.valueOf(demail).toString();
					}
					user.setEmail(email);
					//生日
	...
	public List<UserRole> getUserRolesByUserId(String id) {
		// TODO Auto-generated method stub
		return userDao.UserRolesByUserId(id);
	}
	@Override
