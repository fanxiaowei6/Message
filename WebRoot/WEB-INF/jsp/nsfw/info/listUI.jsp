				...
				<div class="p_d_1_1">
					<div class="content_info">
						...
						<div class="search_art">
							<li>
								信息标题：
								<s:textfield name="info.title" cssClass="s_text" id="infoTitle"
								...
								<s:if test="pageResult.totalCount > 0">
									<s:iterator value="pageResult.items" status="st">
										<tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if>>
											...
											<td id="show_<s:property value='infoId'/>" align="center">
												<s:property value="state==1?'发布':'停用'" />
											</td>
											<td align="center">
												<span id="oper_<s:property value='infoId'/>"> <s:if
														test="state==1">
														<a
												...
												<a
													href="javascript:doDelete('<s:property value='infoId'/>')">删除</a>
											</td>
										</tr>
									</s:iterator>
								</s:if>
						...
						<table width="100%" class="pageDown" border="0" cellspacing="0"
							...
							<tr>
								<td align="right">
									...
									<a href="javascripts:doGoPage(<s:property value="pageResult.pageNo-1"/>)" >上一页</a>
									</s:if>
