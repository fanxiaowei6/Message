...
<html>
	...
	<body class="rightBody">
		<form id="form" name="form"
			action="${basePath }nsfw/complain_deal.action" method="post"
					...
					<div class="content_info">
						...
						<div class="tableH2">
							...
							<span style="color: red;">(<s:property
									value="#complainStateMap[complain.state]" />)</span>
						</div>
						<table id="baseInfo" width="100%" align="center" class="list"
							...
							<tr>
								...
								<td>
									<s:property value="complain.toCompDept" />
								</td>
							</tr>
							<tr>
								<td class="tdBg">
								...
								<td>
									<s:property value="complain.toCompName" />
								</td>
							</tr>
							<tr>
								<td class="tdBg">
								...
								<td>
									<s:property value="complain.compTitle" />
								</td>
							</tr>
							<tr>
								<td class="tdBg">
							...
							<tr>
								...
								<td>
									...
									<s:hidden name="reply.replyer"
										value="%{#session.SYS_USER.name}" />
								</td>
							</tr>

							<tr>
								<td class="tdBg" width="200px">
									回复内容：
								</td>
								<td>
