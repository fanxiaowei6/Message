					...
					<div class="content_info">
						...
						<table id="baseInfo" width="100%" align="center" class="list"
							...
							<tr>
								...
								<td>
									<s:select id="toCompDept" name="comp.toCompDept"
										list="#{'':'请选择','部门A':'部门A','部门B':'部门B' }"
							...
							<tr>
								...
								<td>
									<s:textarea id="editor" name="comp.compContent"
										cssStyle="width:90%;height:160px;" />
								</td>
							</tr>
							<tr>
								<td class="tdBg">
								...
								<td>
									<s:radio name="comp.isNm" list="#{'false':'非匿名投诉','true':'匿名投诉' }" value="true"/>
						...
						<!-- 非匿名时需要保存举报人身份信息 -->
						<s:hidden name="comp.comCompany" value="%{#session.SYS_USER.dept}"/>
